                    ...
                    <div className="flex animate-infinite-scroll cursor-pointer">
                        {scrollingImages.map((src, index) => (
                            ...
                            >
                                ...
                                <div className="absolute inset-0 bg-[rgb(254,94,21)]/80 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                                    <span className="text-white font-bold text-2xl border-2 border-white px-6 py-2">
                                        View Details
                                    </span>
                                </div>
                            </div>
